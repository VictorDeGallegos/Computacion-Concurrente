...
/**
 * Clase que resuelve sopas de letras, tanto el sopa de letras
 * como las palabras vienen en archivos independientes.
 * @author Juan Carlos Bautista Sandoval
 * @version 1.0.0
 */
public class SopaDeLetrasSecuencial {
     ...
     */
    public SopaDeLetrasSecuencial (String rutaSopa, String rutaPalabras) {
    ...
    /**
     * Metodo que revisa si las palabras se encuentran en el sopa de letras en forma horizontal.
     */
    private void revisaHorizontal () {
    ...
    /**
     * Metodo que revisa si las palabras se encuentran en el sopa de letras en forma vertical.
     */
    private void revisaVertical () {
